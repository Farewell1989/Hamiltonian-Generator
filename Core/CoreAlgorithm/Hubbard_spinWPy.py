# -*- coding: utf-8 -*-
"""
Created on Mon Feb 29 13:57:43 2016
...
from Hamiltonian.Core.BasicClass.Hubbard_SpinWGenerator import *
...
class Hubbard_SpinW(Engine):
    
    
    def __init__(self,lattice=None,hopping=[],hubbard=[],terms=[],order=None,**karg):
        '''
        Constructor.
        '''
        ...
        self.order=order
        self.generators={}
        self.generators['h']=Hubbard_SpinWGenerator(self.lattice.dim,self.order,self.lattice.superbonds,hopping=self.hopping,hubbard=self.hubbard,terms=self.terms)
